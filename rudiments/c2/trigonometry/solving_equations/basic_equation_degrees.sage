...
PROBLEM[2] = 'Solve the equation $ %s = %s $ for $x$ in the range $[-360,360]$'%(latex(f(x)), latex(y))

Problem()

# Define the solution

SOLUTION[1] = 'To begin with, we take the inverse function of both sides to give $$ %s = %s '%(
    latex(x),
